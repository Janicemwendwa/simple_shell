...
/**
 * error_f - frees alloc'd pointers following system error
...
/**
 * tokens_f - free memory allocated dynamically by tokenize()
...
/**
 * paths_f - Free the global variable containing the PATH environment
 *              variable value
 *
 * Return: Nothing
 */
